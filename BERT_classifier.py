...
df = pd.read_excel('/Users/godspeed/Desktop/AEI_Paper_Yangdi/train_set.xlsx')
# Print the dataset
print(df.head())
...
website_texts = []
id = 0
#screening the weboage content and store in a dataset for Bert training
...
output_file_path = '/Users/godspeed/Desktop/AEI_Paper_Yangdi/scrapy_train_set_18.xlsx'
df.to_excel(output_file_path, index=False)

train = pd.read_excel('/Users/godspeed/Desktop/AEI_Paper_Yangdi/scrapy_train_set_18.xlsx')
...
# Split the dataset into training and temporary sets (80%-20%)
...
train_data_loader = DataLoader(train_dataset, batch_size=20, shuffle=True)#, num_workers=4)
val_data_loader = DataLoader(val_dataset, batch_size=10, shuffle=False)#, num_workers=4)
test_data_loader = DataLoader(test_dataset, batch_size=10, shuffle=False)#, num_workers=4)

# # Create dataset and dataloaders
# X_train, X_val, y_train, y_val = train_test_split(texts, labels, test_size=0.3, random_state=69)
# train_dataset = WebsiteDataset(X_train, y_train, tokenizer, max_length=512)
# val_dataset = WebsiteDataset(X_val, y_val, tokenizer, max_length=512)
#
...
torch.save(model.state_dict(), 'website_classifier_1.pt')
...
model_path = 'website_classifier_1.pt'
...
use = pd.read_excel('/Users/godspeed/Desktop/AEI_Paper_Yangdi/use_set.xlsx')
# Print the dataset
print(use.head())
...
output_file_path = '/Users/godspeed/Desktop/AEI_Paper_Yangdi/classified_use_set_test.xlsx'
